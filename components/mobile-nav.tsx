...
const LINKS = [
  ...
  { href: '/tournaments/onion-baggers-cup', label: 'OB Cup' },
  ...
  return (
    <div className="relative">
      <button
        ...
        className="relative z-50 p-2.5 -mr-2 rounded-md text-ink-2 hover:text-white focus:outline-none focus:ring-2 focus:ring-brand-2"
      >

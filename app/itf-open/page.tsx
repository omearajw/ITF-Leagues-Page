...
export default async function Index() {
  ...
  // 1. Fetch managers and their scores
  // Notice how we reach into 'managers(real_name)' now
  ...
  return (
    <main className="max-w-4xl mx-auto p-8 font-sans">
      ...
      <p className="text-gray-500 mb-8">The master leaderboard across all divisions.</p>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse">
          ...
          <tbody>
            {/* Added ': any' and ': number' to fix the TypeScript error */}
            {managers?.map((manager: any, index: number) => (
              <tr key={manager.manager_fpl_id} className="border-b border-gray-100 hover:bg-gray-50">
                ...
                <td className="p-3">
                  ...
                  {/* Reaching into the managers table for the real name */}
